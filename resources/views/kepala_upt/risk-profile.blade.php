                        ...
                        <tbody>
                            @foreach ($risikos as $risiko)
                                <tr>
                                    ...
                                    <td class="overflow-scroll" style="max-width: 300px; overflow-y: hidden !important;">
                                        {{ $risiko->potensi_efek }}</td>
                                    <td class="text-center">{{ $risiko->severity }}</td>
                                    <td class="text-center">{{ $risiko->occurrence }}</td>
                                    <td class="text-center">{{ $risiko->detection }}</td>
                                    <td class="text-center fw-bold">{{ $risiko->rpn }}</td>
                                    <td
                                        class="text-center text-gray-100 fw-bold {{ str_replace(' ', '-', strtolower($risiko->kategori)) }}">
                                        {{ $risiko->kategori }}</td>
                                </tr>
                            @endforeach
                        </tbody>
